...
const def = {
  artifact_1: {
    ...
    statementBottom: ['ƒ(-1) < 0', 'ƒ(0) < 0', 'ƒ(1) < 0'],                 //* enunciado 
    conditions: {                                                          //* condiciones para la validación
      conexa: { type: 1 },                                              //* tipo de curva
      compare: {values: [[-1, '<', 0], [0, '<', 0], [1, '<', 0]]},     //* valores a comparar para saber si es valido
    },
  },
  ...
  artifact_10: {
    board: 'board_1',
    statementBottom: ['ƒ(-1) = 1', 'ƒ(0) > 0', 'ƒ(1) < 0'], 
    conditions: { 
      conexa: { type: 1 },
      compare: {values:  [[-1, '=', 1], [0, '>', 0], [1, '<', 0]]}, 
    },
  },
